...
class MainView:View("Simple Compressor by Greimul") {
    ...
    var processDeText = SimpleStringProperty("...")
        ...
        hbox {
            vbox {
                ...
                button("Decompress!") {
                    ...
                    action{
                        Controller(myself).decompressFile(cfile)
                    }
                }
            }
            vbox {
                ...
                label() {
                    ...
                    textProperty().bind(processDeText)
                }
            }
        }
        label("Greimul"){
    ...
    fun changeDeFinishText(fin:File){
        processDeText.set("Finish " + fin.name)
    }
}